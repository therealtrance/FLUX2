...
export default function App() {
  ...
  const duplicateScenario = (scenario) => {
    ...
    setExpandedProjects((prev) => ({
      ...prev,
      ...Object.fromEntries(clonedProjects.map((project) => [project.id, false])),
    }))
